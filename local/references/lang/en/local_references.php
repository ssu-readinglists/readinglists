...
$string['config_jn_online_location_desc'] = 'Will be used in the \'Note\' field (\'no\') for journals with an online location';
$string['config_vid_online_location'] = 'Location note for digital videos';
$string['config_vid_online_location_desc'] = 'Will be used in the \'Note\' field (\'no\') for videos with an online location';
$string['config_bk_print_location'] = 'Location note for printed books';
$string['config_bk_print_location_desc'] = 'Will be used in the \'Note\' field (\'no\') for books with a physical location. Will only be used if a location note cannot be automatically populated';
